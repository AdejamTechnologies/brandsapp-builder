  ...
  schema: {
    ...
    source: {
      ...
      options: [
        ...
        { label: "Ebooks · Featured", value: "ebooks.featured" },
        { label: "Services · Bookable", value: "services.bookable" },
        { label: "Properties · Featured", value: "properties.featured" },
        { label: "Rooms · Available", value: "rooms.available" },
        { label: "Reviews · Top rated", value: "reviews.top" },
      ],
    },
